...
VENDOR_PLATFORM_LINKS := \
	...
	$(TARGET_OUT_VENDOR)/lib64/gc16b3c_aac_front_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/gc16b3c_aac_front_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/gc16b3c_aac_front_i_mipi_raw_IdxMgr.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/imx882_aac_main_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_aac_main_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_aac_main_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_aac_main_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/imx882_ofilm_main_ii_mipi_raw_tuning.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/libaiawb_sun_model.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/lib_bsscore.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/libcamalgo.mfnr.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/libmemtrack_GL.so \
	$(TARGET_OUT_VENDOR)/lib64/libmfllcore.so \
	$(TARGET_OUT_VENDOR)/lib64/libmnl.so \
	$(TARGET_OUT_VENDOR)/lib64/libmpvr.so \
	...
	$(TARGET_OUT_VENDOR)/lib64/libsrv_um.so \
	$(TARGET_OUT_VENDOR)/lib64/libstereoinfoaccessor_vsdof.so \
	$(TARGET_OUT_VENDOR)/lib64/libufwriter.so \
	$(TARGET_OUT_VENDOR)/lib64/libusc.so \
	$(TARGET_OUT_VENDOR)/lib64/libvainr_model.so \
	$(TARGET_OUT_VENDOR)/lib64/mtk000_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/mtk000_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/mtkcam/libmtkcam_streaminfo_plugin-p1stt.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_ii_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_aac_main_ii_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5khm6_ofilm_main_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc1620_ofilm_front_ii_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_aac_depth_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202cs_ofilm_depth_ii_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202_ofilm_macro_ii_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc202pcs_aac_macro_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_aac_ultra_i_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_ofilm_ultra_ii_mipi_raw_global_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_ofilm_ultra_ii_mipi_raw_global_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_ofilm_ultra_ii_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/sc820cs_ofilm_ultra_ii_mipi_raw_india_IdxMgr.so \
